 ...
 * @author Wahyu devi
 */
public class Kalkulator1841720132nining extends javax.swing.JFrame {
        float a, hasil;
        String oprasi;
    /**
     * Creates new form Kalkulator
     */
    public Kalkulator1841720132nining() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator1841720132nining.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator1841720132nining().setVisible(true);
            }
        });
    }
