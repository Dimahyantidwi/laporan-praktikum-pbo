...
public class TampilGui1841720132nining extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720132nining DataMahasiswa;
    
    public TampilGui1841720132nining() {
        initComponents();
        DataMahasiswa = new InputData1841720132nining();
        LihatDataMahasiswa();
    }
    public final void LihatDataMahasiswa() {
        ...
        int i = 0;
        for (Mahasiswa1841720132nining mhs: DataMahasiswa.getData()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720132nining.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720132nining().setVisible(true);
            }
        });
    }
